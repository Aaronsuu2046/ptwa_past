...
class Game {
    ...
    checkAnswer(answer) {
        ...
        if(question === "day") this.record.q.push(gameData.gameData[this.level].q.replace("ロ" , "日。"));
        if(question === "hour") this.record.q.push(gameData.gameData[this.level].q.replace("ロ" , "小時。"));
        if(question === "minute") this.record.q.push(gameData.gameData[this.level].q.replace("ロ" , "分鐘。"));
        if(question === "second") this.record.q.push(gameData.gameData[this.level].q.replace("ロ" , "秒鐘。"));
